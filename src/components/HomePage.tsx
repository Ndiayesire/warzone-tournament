  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/20 to-blue-600/20 animate-pulse"></div>
          ...
          <div className="text-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
                ...
                <span className="text-yellow-400 font-bold"> 50 000 FCFA</span>
              </p>
            </div>
            
            <div className="animate-slide-up">
              <div className="inline-flex items-center space-x-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full px-8 py-4 text-white font-semibold text-lg shadow-2xl hover:shadow-orange-500/25 transition-all duration-300 transform hover:scale-105">
      ...
      <div className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-slate-800/50 rounded-2xl p-8 border border-slate-700 hover:border-orange-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl mb-6 group-hover:rotate-12 transition-transform duration-300">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white">
              <div className="text-3xl font-bold mb-2">6ème-10ème</div>
            ...
            <div className="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl p-6 text-white">
              <div className="text-3xl font-bold mb-2">11ème+</div>
